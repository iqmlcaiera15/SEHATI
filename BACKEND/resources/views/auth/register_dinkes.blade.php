...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register Dinas Kesehatan') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('register.dinkes') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <!-- DINKES Specific Fields -->
                        <hr>
                        <h5>Informasi Dinas Kesehatan</h5>
                        ...
                        <div class="row mb-3">
                            <label for="alamat_kantor" class="col-md-4 col-form-label text-md-end">{{ __('Alamat Kantor') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="nama_admin" class="col-md-4 col-form-label text-md-end">{{ __('Nama Admin') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="foto_ktp" class="col-md-4 col-form-label text-md-end">{{ __('Foto KTP') }}</label>
                            <div class="col-md-6">
                                <input id="foto_ktp" type="file" class="form-control @error('foto_ktp') is-invalid @enderror" name="foto_ktp">
                                @error('foto_ktp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
