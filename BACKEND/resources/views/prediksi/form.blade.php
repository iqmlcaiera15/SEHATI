...
<div class="container-fluid py-4">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-7 col-md-9"> <!-- Sedikit lebih kecil dari col-8 -->
                    ...
                    <form action="{{ route('prediksi.store') }}" method="POST" class="needs-validation" novalidate autocomplete="off">
                        ...
                        <div class="row gy-3 gx-4">
                            ...
                            @if(Auth::user()->role === 'bidan')
                                <div class="col-md-6">
                                    <label for="user_id" class="form-label">Nama Ibu Hamil <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="usia_ibu" class="form-label">Usia Ibu <span class="text-danger">*</span></label>
                                ...
                                <small class="text-muted">Usia antara 15–50 tahun</small>
                                @error('usia_ibu')
                            ...
                            <div class="col-md-6">
                                <label for="riwayat_persalinan" class="form-label">Riwayat Persalinan <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="posisi_janin" class="form-label">Posisi Janin <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="riwayat_kesehatan_ibu" class="form-label">Riwayat Kesehatan Ibu <span class="text-danger">*</span></label>
                                ...
                                <small class="text-muted">Tulis “hipertensi”, atau jika sehat tulis “tidak ada”. Tidak boleh angka saja.</small>
                            ...
                            <div class="col-md-6">
                                <label for="kondisi_kesehatan_janin" class="form-label">Kondisi Kesehatan Janin <span class="text-danger">*</span></label>
                        ...
                        <div class="mt-4 text-end">
                            <button type="submit" class="btn btn-gradient-main px-4 py-2 fw-bold d-inline-flex align-items-center gap-2 shadow-sm rounded-3" style="font-size: 1.07rem;">
...
<style>
    ...
    .btn-gradient-main {
        ...
        border: none;
        font-size: 1.07rem;
        box-shadow: 0 2px 12px rgba(30,170,255,0.08);
    ...
    .card { max-width: 570px; margin: 0 auto; }
</style>
@endsection
